# m4 Lens: Generated Boring Repetition

<meta-instruction>
Use this lens only when the problem shape matches: OpenAPI clients, Prisma types, GraphQL, ATProto lexicons, route helpers.
</meta-instruction>

## Guidance

<positive-directives>
- Generate from one source of truth. Keep output reproducible and boring. Do not hide business logic in generation.
...
const routes = { getUser: { method: "GET", path: "/users/:id" } } as const;
</example>
